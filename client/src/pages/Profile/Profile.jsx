...
const Profile = () => {
  ...
  if (loadingData) {
    return <div className="dashboard-page" style={{textAlign: 'center', opacity: 0.5}}>Loading profile...</div>
  }
    ...
    <div className="dashboard-page">
      ...
      <div className="glass-container profile-card">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" disabled={loading} className="btn btn-primary" style={{ maxWidth: '200px' }}>
